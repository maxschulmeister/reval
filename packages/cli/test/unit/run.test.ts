...
describe('Run Command', () => {
  ...
  it('runs benchmark with default options', async () => {
    ...
    const { lastFrame, waitUntilExit } = render(<Run options={{}} />);
    await waitUntilExit();
  ...
  it('passes all options to core run function', async () => {
    ...
    const { waitUntilExit } = render(<Run options={options} />);
    await waitUntilExit();
  ...
  it('handles dry run mode', async () => {
    ...
    const { lastFrame, waitUntilExit } = render(<Run options={{ dry: true }} />);
    await waitUntilExit();
